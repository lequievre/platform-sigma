...
0- Add Ip address and name of the user's laptop to /etc/hosts of the hand computer:
...
see and adapt the script sample net_user_hand_sigma.h saved in the directory :
/home/pantilt/git_project/platform_sigma/src/scripts_net/hand

You just have to adapt the hardware address of eth0 -> 
for example : hw_ethX_associate_switch="2c:44:fd:68:fb:58"

3- Add Ip address and name of hand computer to /etc/hosts of user's laptop :
192.168.100.113 hand-OptiPlex-7040

4- On each new terminal window on user's laptop, set the ROS MASTER URI :
export ROS_MASTER_URI=http://hand-OptiPlex-7040:11311
