...
from sr_gui_joint_slider_lh.sliders_lh import JointController, Joint, EtherCATHandSlider
from sr_gui_joint_slider_lh.sliders_lh import EtherCATHandTrajectorySlider, EtherCATSelectionSlider


class SrGuiJointSlider_lh(Plugin):
    ...
    def __init__(self, context):
        super(SrGuiJointSlider_lh, self).__init__(context)
        self.setObjectName('SrGuiJointSlider_lh')
        ...
        ui_file = os.path.join(rospkg.RosPack().get_path(
            'sr_gui_joint_slider_lh'), 'uis', 'SrJointSlider.ui')
        loadUi(ui_file, self._widget)

        self._widget.setObjectName('SrJointSliderUi_lh')
    ...
    def load_new_sliders_(self):
        ...
        for joint in self.joints:
            ...
            slider_ui_file = os.path.join(
                rospkg.RosPack().get_path('sr_gui_joint_slider_lh'), 'uis', 'Slider.ui')
        ...
        selection_slider_ui_file = os.path.join(
            rospkg.RosPack().get_path('sr_gui_joint_slider_lh'), 'uis', 'SelectionSlider.ui')
    ...
    def get_current_controllers(self):
        ...
        list_controllers = rospy.ServiceProxy(
            '/lsh/controller_manager/list_controllers', ListControllers)
        try:
        ...
        if success:
            ...
            rospy.loginfo(
                "Couldn't get list of controllers from /lsh/controller_manager/list_controllers service")
            return []
    ...
    def _create_joints(self, controllers):
        ...
        for controller in controllers:
            if rospy.has_param("/lsh/" + controller.name):
                ctrl_params = rospy.get_param("/lsh/" + controller.name)
