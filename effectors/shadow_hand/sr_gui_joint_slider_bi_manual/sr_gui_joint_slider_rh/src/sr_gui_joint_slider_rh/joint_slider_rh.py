...
from sr_gui_joint_slider_rh.sliders_rh import JointController, Joint, EtherCATHandSlider
from sr_gui_joint_slider_rh.sliders_rh import EtherCATHandTrajectorySlider, EtherCATSelectionSlider


class SrGuiJointSlider_rh(Plugin):
    ...
    def __init__(self, context):
        super(SrGuiJointSlider_rh, self).__init__(context)
        self.setObjectName('SrGuiJointSlider_rh')
        ...
        ui_file = os.path.join(rospkg.RosPack().get_path(
            'sr_gui_joint_slider_rh'), 'uis', 'SrJointSlider.ui')
        loadUi(ui_file, self._widget)

        self._widget.setObjectName('SrJointSliderUi_rh')
    ...
    def load_new_sliders_(self):
        ...
        for joint in self.joints:
            ...
            slider_ui_file = os.path.join(
                rospkg.RosPack().get_path('sr_gui_joint_slider_rh'), 'uis', 'Slider.ui')
        ...
        selection_slider_ui_file = os.path.join(
            rospkg.RosPack().get_path('sr_gui_joint_slider_rh'), 'uis', 'SelectionSlider.ui')
